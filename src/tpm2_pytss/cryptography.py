...
class tpm_rsa_private_key(rsa.RSAPrivateKey):
    ...
    def decrypt(self, ciphertext: bytes, padding: padding.AsymmetricPadding) -> bytes:
    ...
    def public_key(self) -> rsa.RSAPublicKey:
        ...
        """
        return cast(rsa.RSAPublicKey, public_to_key(self._public))
    ...
    def get_digest_algorithm(self) -> Type[hashes.HashAlgorithm]:
    ...
    def get_decryption_padding(self) -> padding.AsymmetricPadding:
        ...
        """
        decrypt_padding: padding.AsymmetricPadding
...
class tpm_ecc_private_key(ec.EllipticCurvePrivateKey):
    ...
    def public_key(self) -> ec.EllipticCurvePublicKey:
        ...
        """
        return cast(ec.EllipticCurvePublicKey, public_to_key(self._public))
