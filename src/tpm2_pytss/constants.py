...
class TSS2_RC(TPM_BASE_RC):
    ...
    if _lib_version_atleast("tss2-policy", "3.2.0-63-gdcdc8412"):
        POLICY_RC_GENERAL_FAILURE = lib.TSS2_POLICY_RC_GENERAL_FAILURE
        POLICY_RC_IO_ERROR = lib.TSS2_POLICY_RC_IO_ERROR
        POLICY_RC_AUTHORIZATION_UNKNOWN = lib.TSS2_POLICY_RC_AUTHORIZATION_UNKNOWN
        POLICY_RC_BAD_VALUE = lib.TSS2_POLICY_RC_BAD_VALUE
        POLICY_RC_MEMORY = lib.TSS2_POLICY_RC_MEMORY
        POLICY_RC_BAD_REFERENCE = lib.TSS2_POLICY_RC_BAD_REFERENCE
        POLICY_RC_BAD_TEMPLATE = lib.TSS2_POLICY_RC_BAD_TEMPLATE
        POLICY_RC_POLICY_NOT_CALCULATED = lib.TSS2_POLICY_RC_POLICY_NOT_CALCULATED
        POLICY_RC_BUFFER_TOO_SMALL = lib.TSS2_POLICY_RC_BUFFER_TOO_SMALL
        POLICY_RC_NULL_CALLBACK = lib.TSS2_POLICY_RC_NULL_CALLBACK
...
class TPM2_PT_HR(TPM_FRIENDLY_INT):
    ...
    NV_INDEX = lib.TPM2_PT_HR_NV_INDEX
    ...
    PERSISTENT = lib.TPM2_PT_HR_PERSISTENT
...
class TPMA_CC(TPMA_FRIENDLY_INTLIST):
    ...
    RESERVED1_MASK = lib.TPMA_CC_RESERVED1_MASK
    NV = lib.TPMA_CC_NV
...
class TPMA_ALGORITHM(TPM_FRIENDLY_INT):
    ...
    RESERVED1_MASK = lib.TPMA_ALGORITHM_RESERVED1_MASK
...
class TPMA_PERMANENT(TPMA_FRIENDLY_INTLIST):
    ...
    RESERVED1_MASK = lib.TPMA_PERMANENT_RESERVED1_MASK
...
class TPMA_STARTUP(TPMA_FRIENDLY_INTLIST):
    ...
    CLEAR_RESERVED1_MASK = lib.TPMA_STARTUP_CLEAR_RESERVED1_MASK
...
class TPMA_MODES(TPMA_FRIENDLY_INTLIST):
    FIPS_140_2 = lib.TPMA_MODES_FIPS_140_2
    RESERVED1_MASK = lib.TPMA_MODES_RESERVED1_MASK
